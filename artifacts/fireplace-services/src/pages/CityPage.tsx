...
const cityMaintenanceGuide = {
  ...
  faqs: [
    ...
    { q: "What areas do you serve?", a: "We serve the entire Lower Mainland including Vancouver, Burnaby, Surrey, Coquitlam, Langley, North Vancouver, West Vancouver, New Westminster, Richmond, Port Coquitlam, Port Moody, Maple Ridge, Delta, White Rock, Abbotsford, Mission, Chilliwack, Squamish, and Whistler." },
