      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div className="lg:col-span-2">
          ...
          <p className="mb-6 max-w-md text-slate-300">
            Professional gas fireplace inspection, maintenance, and safety services in Vancouver. 
            Ensuring optimal performance and absolute safety for your home.
          </p>
        ...
        <div>
          <h4 className="text-white font-bold mb-4 text-xl font-display tracking-wide">Contact Us</h4>
        ...
        <div>
          <h4 className="text-white font-bold mb-4 text-xl font-display tracking-wide">24/7 Service</h4>
          <a 
