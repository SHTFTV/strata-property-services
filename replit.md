...
- **City Pages** (`/areas/:city`): 19 city-specific landing pages — all 10 trades listed per city, maintenance guide articles, expanded FAQs
- **Trade Landing Pages** (`/services/:trade`): 10 trade pages — long description, 6-step process, benefits, 5 educational articles, industry insights, materials & methods, strata-specific content, seasonal considerations, safety & compliance, 10+ FAQs
- **Trade+City Pages** (`/services/:trade/:city`): 190 trade × city combo pages — full trade content + city-specific local facts and neighborhoods
...
- `src/data/trades.ts`: 10 trades with features, FAQs, city intro templates, hero images
...
Phone: 604-765-8424, Email: beewarmh@gmail.com, Address: 311-1643 East 3rd Ave Vancouver BC V5N 5R6
...
10 Trades: snow-removal, condo-renovations, hvac, mini-excavation, siding, roofing, landscaping, painting, flooring, perimeter-drain
